                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" action="" data-toggled="validator">
                                    ...
                                    <div class="row gy-4">
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                            <label for="name" class="form-label"> Option Value</label>
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                            <label for="name" class="form-label"> Option Image</label>
                                            <input class="form-control" type="file" id="formFile">
                                        </div>
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                            <button type="submit" class="btn btn-primary btn-wave">Add Option</button>
                                        </div>
                                                        ...
                                                        <th scope="row">
                                                            <div class="d-flex align-items-center">
                                                                <span class="avatar avatar-xs me-2 online avatar-rounded">
                                                                    <img src="https://laravelui.spruko.com/mamix/build/assets/images/faces/3.jpg" alt="img">
                                                                </span>This is Option
                                                            </div>
                                                        </th>
                                                        <td>
                                                            <span class="badge bg-light text-dark">Correct</span>
                                                        </td>
                                                        <td>
