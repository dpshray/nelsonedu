                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table text-nowrap table-bordered">
                                        ...
                                        <tbody>
                                            @foreach($lectureVideos as $lectureVideo)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="hstack gap-2 flex-wrap">
                                                        <a href="{{ route('teacher.lecture_video.edit', [$classroom->id, $lectureVideo->id]) }}" class="text-info fs-14 lh-1" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit">
                                                            <i class="ri-edit-line"></i>
                                                        </a>
                                                        <a href="{{ route('teacher.lecture_video.show', [$classroom->id, $lectureVideo->id]) }}" class="text-info fs-14 lh-1" data-bs-toggle="tooltip" data-bs-placement="top" title="View">
                                                            <i class="ri-eye-line"></i>
                                                        </a>
                                                        <form action="{{ route('teacher.lecture_video.destroy', [$classroom->id, $lectureVideo->id]) }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
