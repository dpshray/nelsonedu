                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="hstack gap-2 flex-wrap">
                                                        @if ($exam->pivot->status && !$exam->pivot->exam_finished)
                                                            <a href="{{ route('student.answer.create', $exam->id) }}" class="btn btn-primary" role="button">Take Exam</a>
                                                        @elseif ($exam->pivot->status && $exam->pivot->exam_finished)
                                                            <a href="{{ route('student.answer.result', $exam->id) }}" class="btn btn-primary" role="button">See Result</a>
                                                        @else
