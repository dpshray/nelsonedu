                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card custom-card">
                            <div class="card-body">
                                <form method="POST" action="{{ route('admin.assign_teacher_exam.store', $exam->id) }}" data-toggled="validator">
                                    @csrf

                                    <div class="row gy-4">
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                            <label for="name" class="form-label"> Exam Name</label>
                                            <input type="text" class="form-control" id="name" name="name" disabled value="{{ $exam->title}}">
                                ...
                                <form action="{{ route('admin.assign_teacher_exam.destroy', $exam->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
