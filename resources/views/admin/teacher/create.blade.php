                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card custom-card">
                            <div class="card-body">
                                <form method="POST" action="{{ $route }}" data-toggled="validator">
                                    @csrf
                                    ...
                                    <div class="row gy-4">
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                            ...
                                            <input type="text" class="form-control" id="name" name="name" value="{{ $teacher->name ??  old('name') }}">
                                            <x-input-error :messages="$errors->get('name')" class="mt-2" />

                                        </div>
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                            <label for="email" class="form-label">Email</label>
                                            <input type="email" class="form-control" id="email" name="email" value="{{ $teacher->email ?? old('email') }}">
                                        ...
                                        @endif
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                            <label for="password" class="form-label"> {{ $title == 'Edit' ? 'New' : '' }} Password</label>
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                            <button type="submit" class="btn btn-primary btn-wave">{{ $title == 'Edit' ? 'Update' : 'Add' }} Teacher</button>
                                        </div>
