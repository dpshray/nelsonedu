                    ...
                    <div class="btn-list">
                        <a href="{{route('admin.news.index')}}">
                            <button class="btn btn-primary-light btn-wave me-2">
                                <i class="bx bx-crown align-middle"></i> Show News/Events
                            </button>
                        </a>
                    </div>
                </div>
                                ...
                                <form method="POST" action="{{ $route }}" data-toggled="validator" enctype="multipart/form-data">
                                    ...
                                    <div class="row gy-4">
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                            ...
                                            <textarea class="form-control" name="description" id="description" required>{{ $news->description ?? old('description') }}</textarea>
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                            <button type="submit" class="btn btn-primary btn-wave">{{ $title == 'Edit' ? 'Update' : 'Add' }} News/Events</button>
                                        </div>
