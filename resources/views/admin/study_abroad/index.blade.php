                        ...
                        <div class="">
                            <nav>
                                <ol class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">List of Study Abroad</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    <div class="btn-list">
                        <a href="{{route('admin.study_abroad.create')}}">
                            <button class="btn btn-primary-light btn-wave me-2">
                                <i class="bx bx-crown align-middle"></i> Add New Study Abroad
                            </button>
                        </a>
                    </div>
                </div>
                                    ...
                                    <table class="table text-nowrap table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $studyAbroad->description }}</td>
                                                <td>{{ $studyAbroad->getFileName($studyAbroad->image)  }}</td>
                                                <td>
                                                    <div class="hstack gap-2 flex-wrap">
                                                        <a href="{{ route('admin.study_abroad.edit', $studyAbroad->id) }}" class="text-info fs-14 lh-1" data-bs-toggle="tooltip"
                                                            data-bs-placement="top" title="Edit"><i
                                                                class="ri-edit-line"></i></a>
                                                        <form action="{{ route('admin.study_abroad.destroy', $studyAbroad->id) }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
