...
<h3 class="blog-details__title">{{$detail->title}}</h3>
...
<h3> <span class="sidebar__post-content-meta"><i class="fas fa-user-circle"></i>Admin</span> <a href="{{url('notice/details/')}}/{{$news->id}}">{{$news->title}}</a>
</h3>
</div>
</li>
@endforeach
